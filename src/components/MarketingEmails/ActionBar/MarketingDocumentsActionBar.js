...
const MarketingDocumentsActionBar = ({
  selectedFolders,
  selectedDocuments,
  store,
  openModal,
  ...
  return (
    <SelectionActionBar
      selectedTotal={selectedFolders + selectedDocuments}
    ...
    >
      <div className="leo-flex-center-between">
        <div className="leo-flex-center-between">
          ...
          />
          <SelectedCounter
            selectedTotal={selectedDocuments}
            selectedText="Documents selected"
          />
        </div>
...
export default MarketingDocumentsActionBar;
