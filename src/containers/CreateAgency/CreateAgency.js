...
import CreateAgencyForm from "components/CreateAgency/CreateAgencyForm";
...
class CreateAgency extends Component {
  constructor() {
    ...
    this.state = {
      ...
      companyName: this.urlParams.get("employer_name"),
  ...
  render() {
    return (
      <PageContainer>
        ...
        <FormContainer>
          <FormWrapper>
            <CreateAgencyForm data={this.state} store={this.props.store} />
          </FormWrapper>
        </FormContainer>
      </PageContainer>
    );
